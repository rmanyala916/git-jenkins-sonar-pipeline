        ...
        node{
            ...
            withSonarQubeEnv('Sonar') { 
                ...
                if (isUnix()) {
                    ...
                    bat (/"${mvnHome}\bin\mvn" org.sonarsource.scanner.maven:SQScanner -f pom.xml  -Dsonar.projectKey=org.sonarqube:java-sonar -Dsonar.projectName="Java :: Simple Spring Project"/)
